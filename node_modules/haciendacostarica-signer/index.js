    ...
    const signature = await xadesXml.Sign(   // Signing document
      ...
      {                                       // options
        ...
        policy: {
          ...
          identifier: {
            qualifier: "OIDAsURI",
            //value: "https://tribunet.hacienda.go.cr/docs/esquemas/2016/v4/Resolucion%20Comprobantes%20Electronicos%20%20DGT-R-48-2016.pdf", //cambio 4.4
            value:"https://cdn.comprobanteselectronicos.go.cr/xml-schemas/Resoluci%C3%B3n_General_sobre_disposiciones_t%C3%A9cnicas_comprobantes_electr%C3%B3nicos_para_efectos_tributarios.pdf",
          }
        },
    });
