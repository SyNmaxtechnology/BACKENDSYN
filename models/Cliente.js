...
Cliente.nuevoCliente = (obj) => {
    ...
    return new Promise((resolve, reject) => {
        const { idemisor, cliente_nombre, cliente_nombre_comercial, cliente_tipo_identificacion, cedula_cliente, numero_cliente, identificacion_extranjero, cliente_barrio, otras_senas, otras_senas_extranjero, cliente_telefono_codigopais, cliente_telefono_numtelefono, cliente_fax_codigopais, cliente_fax_numtelefono, exentoIVA, tipoExoneracion, porcentajeExoneracion, NombreInstitucion, documentoExoneracion, fechaEmision, idusuario, descuento, plazo_credito, cliente_correo, ubicacion, contado } = obj; // destructuring de objetos

        pool.query('INSERT INTO Cliente(idemisor,cliente_nombre, cliente_nombre_comercial, cliente_tipo_identificacion, cedula_cliente, numero_cliente, identificacion_extranjero, cliente_barrio, otras_senas, otras_senas_extranjero, cliente_telefono_codigopais, cliente_telefono_numtelefono, cliente_fax_codigopais, cliente_fax_numtelefono, exentoIVA, tipoExoneracion, porcentajeExoneracion, NombreInstitucion, documentoExoneracion, fechaEmision,agente,descuento,plazo_credito,cliente_correo,ubicacion,contando ) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)', [idemisor, cliente_nombre, cliente_nombre_comercial, cliente_tipo_identificacion, cedula_cliente, numero_cliente, identificacion_extranjero, cliente_barrio, otras_senas, otras_senas_extranjero, cliente_telefono_codigopais, cliente_telefono_numtelefono, cliente_fax_codigopais, cliente_fax_numtelefono, exentoIVA, tipoExoneracion, porcentajeExoneracion, NombreInstitucion, documentoExoneracion, fechaEmision, idusuario, descuento, plazo_credito, cliente_correo, ubicacion, contado], function (err, rows, fields) {
            if (err) {
